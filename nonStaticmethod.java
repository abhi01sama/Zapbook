package com_evs_vtiger_generic_method;
...
public class nonStaticmethod {
	 ...
	 * @param teatCaseName
	 */
	public void extentReport(String fileNameOfExtendeport, String teatCaseName) {
		...
		test.log(Status.INFO, "Report generates successfully");
	...
	public void emplicitWait(int time) {
		try {
